Operation =1
Option =0
Where ="(((comm_transaction.salesperson_key_id)<>\"Internal\") AND ((comm_customer_maste"
    "r.sales_plan_cd)=\"DENCORP\"))"
Begin InputTables
    Name ="comm_configure"
...
Begin OutputColumns
    ...
    Alias ="DCC_ADJ"
    Expression ="IIf([comm_customer_master]![SPM_ReasonTxt]=\"TRACK.DCC\",\"ADJ.COMM\",\"\")"
