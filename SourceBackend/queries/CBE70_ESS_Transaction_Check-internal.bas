...
Where ="(((comm_transaction.ess_salesperson_cd) Like \"ESS*\" Or (comm_transaction.ess_s"
    ...
    "person_code_map.salesperson_cd) Is Null)) OR (((comm_transaction.salesperson_key"
    "_id) Like \"int*\") AND ((comm_transaction.ess_salesperson_cd) Like \"ESS*\" Or "
    "(comm_transaction.ess_salesperson_cd) Like \"CCS*\" Or (comm_transaction.ess_sal"
    "esperson_cd) Like \"DTS*\"))"
Begin InputTables
    Name ="comm_configure"
