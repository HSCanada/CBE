...
Having ="(((comm_free_goods_redeem.CalMonth)=[enter fisc]))"
Begin InputTables
...
Begin OutputColumns
    ...
    Alias ="FirstOfgroup_equipment_opt_out_ind"
    Expression ="First(comm_free_goods_redeem.group_equipment_opt_out_ind)"
