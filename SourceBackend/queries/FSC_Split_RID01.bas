Operation =1
Option =0
Where ="(((comm_transaction.fiscal_yearmo_num)=\"201603\") AND ((comm_transaction.salesp"
    "erson_key_id)<>\"Internal\") AND ((comm_customer_master.sales_plan_cd)=\"RID01\""
    "))"
Begin InputTables
    Name ="comm_configure"
...
dbMemo "OrderBy" ="[FSC_Split_RID01].[item_comm_group_cd]"
Begin
    Begin
