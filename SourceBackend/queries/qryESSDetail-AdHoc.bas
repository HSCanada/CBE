Operation =1
Option =0
Where ="(((comm_transaction.fiscal_yearmo_num)>=\"202001\") AND ((comm_transaction.sourc"
    "e_cd)=\"IMPORT\") AND ((comm_transaction.salesperson_key_id)<>\"\") AND ((comm_t"
    "ransaction.ess_salesperson_key_id)<>\"\"))"
Begin InputTables
...
dbMemo "OrderBy" ="[qryESSDetail-AdHoc].[fiscal_yearmo_num], [qryESSDetail-AdHoc].[ess_salesperson_"
    "key_id]"
Begin
    Begin
